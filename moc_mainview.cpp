...
QT_MOC_LITERAL(4, 36, 10) // "eventPress"

    },
    "MainView\0mousePressed\0\0QMouseEvent*\0"
    "eventPress"
};
...
void MainView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MainView::*_t)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MainView::mousePressed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MainView::mousePressed(QMouseEvent * _t1)
{
