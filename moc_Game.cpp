...
QT_MOC_LITERAL(4, 33, 10), // "pressEvent"
QT_MOC_LITERAL(5, 44, 15), // "onPositionTimer"
QT_MOC_LITERAL(6, 60, 11), // "onDrawTimer"
QT_MOC_LITERAL(7, 72, 14) // "onMousePressed"

    },
    "CGame\0mousePressed\0\0QMouseEvent*\0"
    "pressEvent\0onPositionTimer\0onDrawTimer\0"
    "onMousePressed"
};
...
void CGame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onPositionTimer(); break;
        case 2: _t->onDrawTimer(); break;
        case 3: _t->onMousePressed((*reinterpret_cast< QMouseEvent*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (CGame::*_t)(QMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CGame::mousePressed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CGame::mousePressed(QMouseEvent * _t1)
{
